...
Please give me feedback, contribute and file technical bugs on [GitHub Repository](https://github.com/triopsi/th-reviews-bar). Thanks :)
...
1. Upload `th-reviews-bar` to the `/wp-content/plugins/` directory
...
= 1.0.2 =
* FIX "Please fill the Author name field!"-Message
