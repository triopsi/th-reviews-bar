	...
	public function form( $instance ) {
		...
		<div style="margin-bottom:10px;">
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'imagecurved' ) ); ?>"><?php esc_html_e( 'Images have a round radios', 'thrb' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'random' ) ); ?>"><?php esc_html_e( 'Show random reviews instead of sorted by date', 'thrb' ); ?></label>
			</p>

			<p id="<?php echo esc_attr( $this->get_field_id( 'orderfield' ) ); ?>">
				<label for="<?php echo $this->get_field_id( 'order' ); ?>">
					<?php esc_html_e( 'Sorted by', 'thrb' ); ?>
				</label>
				...
				<small>ASC: <?php esc_html_e( 'ascending order from newest to oldest date', 'thrb' ); ?></small><br>
				<small>DESC: <?php esc_html_e( 'descending order from oldest to newest date', 'thrb' ); ?></small>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id( 'limit' ); ?>">
					<?php esc_html_e( 'Number of reviews to show', 'thrb' ); ?>
				</label>
				...
				<small>-1 <?php esc_html_e( 'to show all reviews.', 'thrb' ); ?></small>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'showauthorname' ) ); ?>"><?php esc_html_e( 'Show author name on review', 'thrb' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'showstars' ) ); ?>"><?php esc_html_e( 'Show stars on review', 'thrb' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'showtitle' ) ); ?>"><?php esc_html_e( 'Show the title of the review', 'thrb' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'showdescription' ) ); ?>"><?php esc_html_e( 'Show the descriptions of review', 'thrb' ); ?></label>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id( 'before' ); ?>">
					<?php esc_html_e( 'HTML or text before the random review', 'thrb' ); ?>
				</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'after' ); ?>">
					<?php esc_html_e( 'HTML or text after the random review', 'thrb' ); ?>
				</label>
