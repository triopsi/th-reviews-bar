...
{
    echo __('This color will use for the review section','thrb');
}
...
{
    echo __('Want to use the CDN for Font Awesome Icons?','thrb');
}
...
function thrb_settings_section_cb()
{
    ...
    printf(__('By default the plugin used and needed the font awesome icon libary(%s).','thrb'),
...
function thrb_settings_field_hover_color_cb( array $args ){
    ...
    ?>
    <input type="text" id="thrb-hover-color-field" class="thrb-hover-color-field" name="thrb_setting_border_color_hover" value="<?php echo $old_setting_value; ?>">
    <?php
}
...
function thrb_show_all_posts(){
    ...
    $post_type_arg = array('post_type' => 'thrb', 'posts_per_page' => -1);
